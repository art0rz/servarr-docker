...
PROMPT_SECTIONS: List[PromptSection] = [
    PromptSection(
        ...
        [
            EnvPrompt(
                "MEDIA_DIR",
                "Media directory for downloads and library",
                MEDIA_DEFAULT_DIR,
            ...
            EnvPrompt(
                "DOCKER_GID",
                "Docker group ID (for health server)",
                _default_docker_gid(),
                validator=_validate_positive_int,
            ),
    ...
    PromptSection(
        ...
        [
            EnvPrompt(
                "SERVARR_USERNAME",
                "Username for Sonarr/Radarr/Prowlarr/qBittorrent/Bazarr",
                "servarr",
                validator=_validate_non_empty,
            ),
            EnvPrompt(
                "SERVARR_PASSWORD",
                "Password for Sonarr/Radarr/Prowlarr/qBittorrent/Bazarr",
                secret=True,
                validator=_validate_non_empty,
            ),
        ],
    ...
    PromptSection(
        ...
        [
            ...
            EnvPrompt(
                ...
                "VPN provider (gluetun supported value)",
                "",
                validator=_validate_non_empty,
            ),
    ...
    PromptSection(
        ...
        [
            ...
            EnvPrompt(
                ...
                "WireGuard server public key override",
                required=False,
                secret=True,
            ),
            EnvPrompt(
                "WIREGUARD_ENDPOINT_IP",
                "WireGuard endpoint IP override",
                required=False,
                validator=_validate_ip_address,
            ),
            EnvPrompt(
                "WIREGUARD_ENDPOINT_PORT",
                "WireGuard endpoint port override",
                required=False,
            ...
            EnvPrompt(
                ...
                "WireGuard allowed IPs override",
                required=False,
                validator=_validate_cidr_list,
            ),
            EnvPrompt(
                "WIREGUARD_IMPLEMENTATION",
                "WireGuard implementation override",
                required=False,
                validator=_validate_wg_implementation,
            ),
            EnvPrompt(
                "WIREGUARD_MTU",
                "WireGuard MTU override",
                required=False,
                validator=_validate_positive_int,
            ),
            EnvPrompt(
